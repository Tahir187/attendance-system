...
router.get("/getLeaveRequests", isAuthorizedUser(["admin"]), adminController.getLeaveRequests);
...
router.get("/attendance/:userId", isAuthorizedUser(["admin"]), adminController.getUserAttendanceRecords);
